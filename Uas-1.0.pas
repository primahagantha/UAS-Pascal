...
uses crt,wincrt;
procedure totalNilai(nilai1:real; nilai2:real; nilai3:real; nilai4:real; nilai5:real; nilai6:real);
	var 
	hasil: char;
	Nilai: real;
	begin
...
for i := 1 to n do
	begin
		...
		writeln('=================================');
		writeln('Nilai sisdig 	- ',sisdig);
		writeln('Nilai TBO 		- ',tbo);
		writeln('Nilai OAK 		- ',Oak);
		writeln('Nilai matdas 	- ',matdas);
		writeln('Nilai daspro 	- ',daspro);
		writeln('Nilai pik 		- ',pik);
		writeln('=================================');
